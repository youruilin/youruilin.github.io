    ...
    try {
      ...
      const res = await fetch(GeminiFetch, {
        headers: {
         ...
         'Authorization': 'Baerer AIzaSyCCkKtfzG8mhc6zYkL7MOPO5fjJDwc9dKY',
        },
        method: 'POST',
        body: JSON.stringify({
          model: 'gpt-4o',
          messages: [
            {
              role: 'system',
              content: "你是一位高度熟练的人工智能，擅长语言理解和摘要。我希望你阅读三引号分隔的文本，并将其总结为简洁的摘要段落。目标是保留最重要的要点，提供一个连贯易懂的总结，帮助读者理解讨论的主要内容，而无需阅读全文。请避免不必要的细节或与主题无关的内容。只需给出输出，不需要使用引号包裹回复。请使用日语回答。",
            },
